    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16 fade-in">
          <h2
            className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 gradient-text"
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="pt-6 sm:pt-8">
                ...
                <div className="flex space-x-3 sm:space-x-4 flex-wrap gap-2">
                  <a
                    href="#"
                    className="w-10 h-10 sm:w-12 sm:h-12 bg-secondary rounded-full flex items-center justify-center hover:bg-accent transition-colors"
                    data-testid="social-behance"
                  >
                    <i className="fab fa-behance text-sm sm:text-base"></i>
                  </a>
                  <a
                    href="https://in.pinterest.com/iball93/"
                    className="w-10 h-10 sm:w-12 sm:h-12 bg-secondary rounded-full flex items-center justify-center hover:bg-accent transition-colors"
                  ...
                  <a
                    href="https://www.instagram.com/i_ball.exe/"
                    className="w-10 h-10 sm:w-12 sm:h-12 bg-secondary rounded-full flex items-center justify-center hover:bg-accent transition-colors"

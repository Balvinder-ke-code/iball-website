    ...
    <div className="min-h-screen pt-24 pb-12 bg-background">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-5xl font-bold gradient-text mb-4" data-testid="page-title">Youtube Thumbnails</h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Eye-catching thumbnails designed to boost click-through rates and grow your channel
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {Array.from({ length: 9 }, (_, index) => (
            <div key={index} className="glass-morphism rounded-2xl overflow-hidden group" data-testid={`thumbnail-placeholder-${index}`}>
              ...
              <div className="p-4">
                <h3 className="font-semibold text-lg mb-2">Thumbnail Design {index + 1}</h3>
                <p className="text-muted-foreground text-sm">Custom thumbnail for YouTube video</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="glass-morphism rounded-2xl p-8 text-center">
          <div className="max-w-md mx-auto">
            ...
            <h3 className="text-2xl font-semibold mb-4">Upload New Thumbnails</h3>
